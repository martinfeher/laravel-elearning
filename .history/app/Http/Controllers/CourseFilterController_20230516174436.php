...
class CourseFilterController extends Controller
{
    ...
    public function getFilterData()
    {
        ...
        $courses = Course::with(['categories', 'tag', 'attributeItem'])->select(['id', 'name', 'excerpt', 'featured_image', 'price', 'sale_price', 'sale_price_value', 'reviews_allowed', 'rating_items', 'rating'])->get();
