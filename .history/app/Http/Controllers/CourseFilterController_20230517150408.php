...
class CourseFilterController extends Controller
{
    ...
    public function getFilterData()
    {
        ...
        $courses = Course::with(['tags', 'courseAttributeItems', 'author'])->select(['id', 'name', 'excerpt', 'featured_image', 'reviews_allowed', 'rating_items', 'rating', 'created_at'])->get();
    ...
    //    
        ...
        foreach($courses as $course) {
            // dd($course->courseCategory()->pluck('category_id'));
            // dd($course->categoryIds());
            $course->categories = $course->courseCategory()->pluck('category_id');
