...
class CourseFilterController extends Controller
{
    ...
    public function getFilterData()
    {
        ...
        $courses = Course::with(['categories', 'tags', 'courseAttributeItems', 'author'])->select(['id', 'name', 'excerpt', 'featured_image', 'reviews_allowed', 'rating_items', 'rating'])->get();
        ...
        foreach($courses as $course) {
            ...
            $course->date = $course->reviewsAllowedBoolean();
