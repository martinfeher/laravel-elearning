...
use App\Models\CourseAttributeItems;
    ...
    public function getFilterData(Request $request)
    {
        ...
        if ($request->has('server_side_update') && $request->server_side_update == 1){
            ...
            if ($request->has('attr') && $request->attr[0]) {
                ...
                dd($attributes);
                $courseIdsCategoriesRq = CourseAttributeItem::where('attribute_id', $attribute_id)->where('attribute_item_id', $attribute_item_id)->pluck('course_id')->toArray();
            }

            if (isset($courseIdsTagsRq) && isset($courseIdsCategoriesRq)) {
