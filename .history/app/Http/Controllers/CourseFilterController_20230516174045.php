...
class CourseFilterController extends Controller
{
    ...
    public function getFilterData()
    {
        ...
        $courses = Course::with(['category', 'tag', 'attributeItem'])->select(['id', 'name', 'excerpt', 'featured_image', 'price', 'sale_price', 'sale_price_value', 'stock_quantity', 'reviews_allowed', 'rating_items', 'rating', 'featured_image'])->get();
        ...
        foreach($courses as $course) {
            ...
            $attributeItem = $course->attributeItem;
        ...
        $categoryTotal = DB::table('category')
