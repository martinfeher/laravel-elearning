    ...
    public function getFilterData(Request $request)
    {
        ...
        if ($request->has('server_side_update') && $request->server_side_update == 1){
            ...
            if ($request->has('attr') && $request->attr[0]) {
                ...
                dd($courseIdsCatego$courseIdsAttributeRqriesRq);
            }

            if (isset($courseIdsTagsRq) && isset($courseIdsCategoriesRq) && isset($courseIdsCategoriesRq)) {
            ...
            if (isset($courseIdsCategoriesRq) || isset($courseIdsTagsRq) ) {
